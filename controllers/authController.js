...
export const forgot = async (req, res) => {
  ...
  try {
    ...
    await updateUser(user, { reset_token: encryptedResetToken, reset_token_expiration: resetTokenExpiration });
...
export const confirmResetPassword = async (req, res) => {
  ...
  try {
    ...
    const passwordHash = await hashPassword(password);
    await updateUser(user, { password: passwordHash, reset_token: null, reset_token_expiration: null });
